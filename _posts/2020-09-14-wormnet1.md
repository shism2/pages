...
# Fully-connected layer with 75% random sparsity and tanh activation
x = tf.keras.layers.Dense(32)(x)
x = tf.keras.layers.Lambda(lambda x: x*np.random.default_rng().binomial(1,0.25,size=32))(x)
...
![award]({{ site.baseurl }}/images/wormnet/ode_to_rnn.jpg "Modelling process in a nutshell")
